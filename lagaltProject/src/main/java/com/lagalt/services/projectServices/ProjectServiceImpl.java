...
public class ProjectServiceImpl implements ProjectService{
    ...
    public ProjectServiceImpl(ProjectRepository projectRepository, RequestRepository requestRepository,
                              TopicRepository topicRepository, UserRepository userRepository, SkillRepository skillRepository) {
    ...
    public Project add(Project project) {
        ...
        if(project.getTopic() == null)
            project.setTopic(existed_project.getTopic());
    ...
    public Project update(Project project) {
        ...
        if(project.getTopic() != null)
            existed_project.setTopic(project.getTopic());
    ...
    // Project's topic method
    public TopicDTO findTopicOfProject(Integer project_id){
        Topic topic = findById(project_id).getTopic();
        if(topic == null)
            return null;
        return Transformer.topicToTopicDTO(topic);
    }
