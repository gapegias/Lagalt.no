...
public class ProjectController {
    ...
    // Project's topic request
    @GetMapping({"{project_id}/topic"})
    public ResponseEntity findTopicOfProject(@PathVariable int project_id){
        return ResponseEntity.ok(this.projectService.findTopicOfProject(project_id));
    }
